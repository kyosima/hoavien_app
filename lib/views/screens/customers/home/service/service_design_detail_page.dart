...
class ServiceDesignDetailPage extends StatelessWidget {
  final controller = Get.put(ServiceDesignDetailController());
  ServiceDesignDetailPage({Key? key}) : super(key: key);
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (_, index) {
                              return CustomService(
                                  onTap: () {
                                    Get.delete<ServiceDesignDetailController>();
                                    Get.to(() => ServiceDesignDetailPage(),
